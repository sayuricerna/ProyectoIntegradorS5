...
<main class="container">
  ...
  <div class="container mw-1620 bg-white border-radius-10">
    ...
    <div class="mb-3 mb-xl-5 pt-1 pb-4"></div>
    <div class="mb-3 mb-xl-5 pt-1 pb-4"></div>
      <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4" id="about">Acerca de Nosotros</h2>
      <div class="row justify-content-center">
        <div class="col-md-8">
          <p class="text-center">
            En <strong>Swinroom</strong> fusionamos lo mejor de lo urbano y lo elegante para crear un estilo único.  
            Somos una tienda de ropa física y online ubicada en Santo Domingo, Ecuador, especializada en prendas <em>oversize</em>, <em>boxyfit</em> y con un toque <em>old money</em>.  
        ...
        <div class=" col-12 mb-4 mb-lg-0">
          ...
          <p class="footer-address">Santo Domingo,📍</p>
          <p class="m-0"><strong class="fw-medium">email@swinroom.com</strong></p>
          <p><strong class="fw-medium">+593 995 712 907</strong></p>
          <ul class="social-links list-unstyled d-flex flex-wrap mb-0">
            <li>
              <a href="https://maps.google.com" target="_blank" class="footer__social-link d-block">
            ...
            <li>
              <a href="tel:+1234567890" class="footer__social-link d-block">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4 text-center text-lg-start">
            ...
            <div class="contact-info">
              ...
              <p class="mb-3"><i class="bi bi-telephone-fill me-2"></i><strong>+593 995 712 907</strong></p>
              
              <ul class="social-links list-unstyled d-flex justify-content-center justify-content-lg-start gap-3 mb-0">
                <li>
                <a href="https://maps.google.com" target="_blank" class="footer__social-link d-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
